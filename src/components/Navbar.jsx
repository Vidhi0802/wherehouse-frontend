    ...
    <Container>
      <Wrapper>
        ...
        <Right>
          ...
          <MenuItem><Link to="/brands" style={{textDecoration: 'none', color: 'black'}}>BRANDS</Link></MenuItem>
          <MenuItem><Link to="/categories" style={{textDecoration: 'none', color: 'black'}}>CATEGORY</Link></MenuItem>
